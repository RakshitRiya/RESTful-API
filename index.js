...
const renderPeopleList = (users) => {
    ...
    users.forEach(user => {
        output+=`<div class="card m-2 col-md-3 bg-light">
        <div class="card-body" data-id="${user.id}" data-name="${user.firstName}">
        <div class="row">
            <div class="column"><h6 class="mr-2">Firstname:<h6></div>
            <div class="column"><h6 class="firstnamecard"> ${user.firstName}</h6></div>
        </div>
        <div class="row">
            <div class="column"><h6 class="mr-2">Lastname:</h6></div>
            <div class="column"><h6 class="lastnamecard"> ${user.lastName}</h6></div>
        </div>
        <div class="row">
            <div class="column"><h6 class="mr-2">Age:</div>
            <div class="column"><h6 class="agecard"> ${user.age}</h6></div>
        </div>
          <a href="#" class="btn btn-outline-warning btn-sm mr-2" id="update-user">Update</a>
